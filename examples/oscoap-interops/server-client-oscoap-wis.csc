...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>80.67243818283383</x>
        <y>85.20124306369792</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>84.5505091288716</x>
        <y>86.63186005373701</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>84.3499569655115</x>
        <y>83.36316632283952</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <skin>org.contikios.cooja.plugins.skins.TrafficVisualizerSkin</skin>
      <skin>org.contikios.cooja.plugins.skins.UDGMVisualizerSkin</skin>
      <viewport>21.956305880220484 0.0 0.0 21.956305880220484 -1538.4144258151753 -1678.790065286799</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
